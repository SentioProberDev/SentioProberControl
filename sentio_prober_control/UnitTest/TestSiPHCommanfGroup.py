...
class TestSiPHCommandGroup(unittest.TestCase):
    ...
    def test_move_hover(self):
        ...
        self.mock_comm.read_line.return_value = "0,0,OK"
        self.test_prober.siph.move_hover(ProbeSentio.East)
        self.mock_comm.send.assert_called_with("siph:move_hover East")

    def test_coupling(self):
        """Test coupling method."""
        self.mock_comm.read_line.return_value = "0,0,OK"
        self.test_prober.siph.coupling(ProbeSentio.East, UvwAxis.V)
    ...
    def test_get_alignment(self):
        ...
        coarse, fine, gradient, rotary = self.test_prober.siph.get_alignment(ProbeSentio.West, FiberType.Single)
    ...
    def test_move_position_uvw(self):
        ...
        position = self.test_prober.siph.move_position_uvw(ProbeSentio.East, UvwAxis.U, 0.1)
    ...
    def test_pivot_point(self):
        ...
        self.mock_comm.read_line.return_value = "0,0,OK"
        self.test_prober.siph.pivot_point(ProbeSentio.West)
    ...
    def test_move_nanocube_xy(self):
        ...
        x, y = self.test_prober.siph.move_nanocube_xy(ProbeSentio.East, 50, 50)
    ...
    def test_get_nanocube_xy(self):
        ...
        self.mock_comm.read_line.return_value = "0,0,50.000,50.000"
        x, y = self.test_prober.siph.get_nanocube_xy(ProbeSentio.East)
    ...
    def test_get_nanocube_z(self):
        ...
        z = self.test_prober.siph.get_nanocube_z(ProbeSentio.West)
